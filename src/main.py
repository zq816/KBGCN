...
parser.add_argument('--l2_weight', type=float, default=1.6e-7, help='weight of l2 regularization')
...
parser.add_argument('--l2_weight', type=float, default=6e-5, help='weight of l2 regularization')
